...
public class IDBuilder {
    ...
    /**
     * 活动报名 订单id生成 首先，订单号有3个性质：1.唯一性 2.不可推测性 3.效率性
     * 唯一性和不可推测性不用说了，效率性是指不能频繁的去数据库查询以避免重复。 况且满足这些条件的同时订单号还要足够的短。
     * 我在java下定制的订单号生成方式如下： 订单ID 目前规则来看，两个人在同一微秒提交订单重复的概率为1%
     *
     * @return
     */
