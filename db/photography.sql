...
CREATE TABLE `article_attr`  (
  `article_attr_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '文章属性关联表，如果有关联或属性此表才有对应的数据',
...
CREATE TABLE `article_content`  (
  `articleId` bigint(0) NOT NULL COMMENT '文章内容表 图文，对应文章id，一个文章只有一个内容',
...
CREATE TABLE `category_relation`  (
  `category_id` bigint(0) NULL DEFAULT NULL COMMENT '分类标签与实体的关联表',
  `bean_type` tinyint(0) NOT NULL COMMENT '关联实体类型 使用枚举',
  `bean_id` bigint(0) NOT NULL COMMENT '关联实体id',
...
CREATE TABLE `category_tag`  (
  `category_tag_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '分类和标签',
...
CREATE TABLE `customer`  (
  `customer_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '用户主表，登录信息',
...
CREATE TABLE `customer_third_bind`  (
  `customer_third_bind_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '第三方账号关联绑定，主要用于登录，所以这里使用cusid',
  `customer_id` bigint(0) NULL DEFAULT NULL COMMENT '用户id',
  `secret_type` tinyint(0) NULL DEFAULT NULL COMMENT '密钥类型 手机号，微信，qq',
...
CREATE TABLE `dict`  (
  `dict_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '字典表',
  `dict_pid` bigint(0) NULL DEFAULT NULL COMMENT '字典父级id',
...
CREATE TABLE `file_list`  (
  `file_list_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '文件统一管理库，如果是为了速度，可使用redis，但是总感觉redis不太可靠',
  `item_type` int(0) NULL DEFAULT NULL COMMENT '文件关联业务类型',
  `item_id` bigint(0) NULL DEFAULT NULL COMMENT '业务id',
...
CREATE TABLE `footer_info`  (
  `footer_info_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '页尾的链接和介绍相关的配置',
  `page_model_id` bigint(0) NULL DEFAULT NULL COMMENT '关联页面的具体配置',
  `footer_data` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '文本 或者url;或者是json数据',
  `enabled` tinyint(0) NULL DEFAULT NULL COMMENT '1可用 0不可用',
...
CREATE TABLE `menu`  (
  `menu_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '菜单表',
...
CREATE TABLE `page_model`  (
  `page_model_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '页面模块配置',
  `pid` bigint(0) NULL DEFAULT NULL COMMENT '如果存在多级的话那么这里就有值',
  `model_type` tinyint(0) NULL DEFAULT NULL COMMENT '模块类型 单行轮播图 多行展示 about 文章',
...
CREATE TABLE `photo_album`  (
  `photo_album_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '相册',
  `customer_user_id` bigint(0) NULL DEFAULT NULL COMMENT '创建人',
...
CREATE TABLE `photo_library`  (
  `photo_library_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '图片库',
  `photo_album_id` bigint(0) NULL DEFAULT NULL COMMENT '相册id 非必须',
  `customer_user_id` bigint(0) NULL DEFAULT NULL COMMENT '创建人',
...
CREATE TABLE `poster`  (
  `poster_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '广告/banner',
  `postion` int(0) NULL DEFAULT NULL COMMENT '广告位置，dictid :adpostion',
  ...
  `item_type` tinyint(0) NULL DEFAULT NULL COMMENT '关联附件类别，1链接 2文章',
...
CREATE TABLE `role`  (
  `role_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '角色权限库',
  `role_type` tinyint(0) NULL DEFAULT NULL COMMENT '角色作用的位置，如：管理端还是用户端',
  `role_name` varchar(24) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '角色名称',
  `enabled` tinyint(0) NULL DEFAULT 1 COMMENT '0禁用 1启用',
...
CREATE TABLE `sys_config`  (
  `sys_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '系统配置',
